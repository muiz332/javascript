...
jadi kalo menurut definisinya 
     ...
     "type data string dalam javascript digunakan untuk mempresentasikan data texttual"

atau data texttual tersebut sering plaint text 

nah untuk menuliskan string pada javascript yang perlu kita lakukan hanya membungkus data atau nilai kita menggunakan tanda kutip 
kalian bisa menggunakan kutip dua "" , atau kutip satu '' ini fungsinya sama saja ya 
...
nah yang perlu kalian ingat adalah jika kalian menuliskan text dengan menggunakan awalan kutif dua
maka harus diakhiri dengan kutip dua juga

kalo diawali dengan kutip satu maka harus diakhiri dengan kutip satu juga

tidak boleh diawali dengan menggunakan kutip dua tapi diakhiri dengan kutip satu
atau sebaliknya, itu tidak boleh

nah sekarang kapan kita menggunakan kutip dua atau kutip satu? sekali lagi ini bebas saja, kalo saya pribadi lebih suka dengan kutip satu kenapa 
karena untuk menulisnya dikeyboard kita tidak usah menekan tombol shift 

ada saatnya kita ingin menuliskan text yang membutuhkan karakter kutip didalam string
kalian, ini penting ya 
contohnya gini 

kalo misalkan didalam string kalian ada karakter kutip satu, maka sebaiknya kalian membungkus kutip kalian menggunakan kutip dua "" 
contoh 
...
ini akan tetap eror juga, kenapa? karena javascript menemukan ada kutip dua berikutnya, itu dianggapnya stringnya sudah selesai 
atau kita coba deh ya, sekarang buka console dibrowser kalian


jika saya ingin menuliskan sebuah string misalnya saya menggunakan kutip dua seperti ini 
"hello world"

maka saya harus tutup dengan kutip dua, dan ketika saya menulisnya dengan kutip satu 
...
escape charakter berfungsi untuk menampilkan sebuah karakter yang dinyatakan berbeda dalam sebuah bahasa pemrogaman 
contohnya kutip tadi 
...
jadi ini yang disebut dengan escape charakter, sehingga nanti kutipnya akan ditampilkan sebagai string kutip 
jadi contoh menulisnya seperti ini 

'"Gerakan Pungut Sampah" dilaksanakan pada hari jum\'at'

jika kalian membungkusnya dengan menggunakan kutip satu dan ingin menampilkan kutip satu, didalamnya tambahkan backslash 
sebelum tanda kutip 
...
nah sekarang ada juga untuk menampilkan unicode, unicode ini untuk menampilkan contohnya symbol,menampilkan symbol dengan menambahkan backslash \u 
lalu urutan angka unicodenya \uxxxx
...
nah ini untuk mehasilkan tm begitu atau google aja unicode javascript
jika ingin menggunakan unicode 


lalu didalam string itu ada yang disebut dengan concatenation/konkatenasi ini dengan menggunakan karakter + saya yakin kalo kalian 
mengikuti materi sebelumnya itu kita sudah pernah mencoba operator + ini sebagai operator matematik/aritmatika atau sebagi operator 
penggabung dua atau lebih string 
...
tapi hati hati disini huruf besar dan huruf kecil itu berbeda meskipun tulisannya sama 
...
jika saya tambahkan .length dibelakangnya maka dia akan menghasilkan sebuah angka, dimana angka ini adalah jumlah karakter yang 
terdapat didalam stringnya, untuk karakter spasi juga dihitung

kita coba, misalkan saya punya string gini
"web programming unpas".length
21

jika saya tambahkan .length, maka dia akan menghasilkan nilai 21 
...
var nama = "Muhammad Mu'izzuddin" bisa juga begini 

var nama
nama = "Muhammad Mu'izzuddin"

lalu saya tulis begini nama.length ini juga bisa
...
oke jadi mungkin itu ya sekilas mengenai string mudah mudahan kalian paham dan nanti string ini adalah salah satu type data yang akan 
banyak sekali kita gunakan diseri ini 
